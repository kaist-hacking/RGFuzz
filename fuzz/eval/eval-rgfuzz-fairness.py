...
GEN = codegen.stackgen.StackGenerator()

def run_generator(seed):
    ctx = codegen.stackgen.StackGenContext(codegen.rng.RandomRng(seed))
    code = GEN.gen_module(ctx).to_bytes()
