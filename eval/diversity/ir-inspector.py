...
if args.cumulative:
    ax.set_title("IR Expressions - All")
    # ax.set_ylabel("Cumulative Frequency")
    fig.savefig(os.path.join(coverage_root, "cumul-ir.png"), bbox_inches = 'tight')
    fig.savefig(os.path.join(coverage_root, "cumul-ir.pdf"), bbox_inches = 'tight')
else:
    ax.set_title("IR Expressions - All")
    # ax.set_ylabel("Frequency")
    fig.savefig(os.path.join(coverage_root, "ir.png"), bbox_inches = 'tight')
    fig.savefig(os.path.join(coverage_root, "ir.pdf"), bbox_inches = 'tight')